...
import backgroundOne from '../images/mathilda-khoo-vLR0YP_otCo-unsplash.jpg';
import backgroundTwo from '../images/pine-watt-2Hzmz15wGik-unsplash.jpg';
const StyledProject = styled.section`
position: relative;
display: grid;
grid-template-column: 35% 15% 1fr;
grid-template-areas:
...
const Project = () => {
    return (
        <StyledProject>
            ...
            <div className='project__img project__img--left invert'
                style={{ backgroundImage: `url(${backgroundOne})` }}
            >

            </div>
            <div className='project__img project__img--right invert'
